          ...
          <div className="flex justify-between items-center px-1">
            ...
            <div className="relative">
              <input 
                ...
                className="bg-white px-3 py-2 rounded-xl border border-slate-100 text-[10px] font-black text-slate-600 outline-none focus:ring-2 focus:ring-emerald-500/20 transition-all cursor-pointer w-40 md:w-44"
              />
            </div>
          </div>
